...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { data, error } = await signUp(email, password, fallbackName, "film_crew")
      ...
      if (error) {
        ...
        console.log("[v0] Signup successful, user created")
        setSuccess(true)
        setTimeout(() => {
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Your account is ready. We are taking you to onboarding now.
            </CardDescription>
          </CardHeader>
          <CardContent>
